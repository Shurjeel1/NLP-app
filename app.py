...
try:
    pipe_lr = joblib.load(file_path)
    # Perform any necessary operations with the loaded file
    print("File loaded successfully!")
except FileNotFoundError:
    print("File not found. Please ensure the file exists at the specified location.")
